...
import {Avatar, Button, Chip, Dropdown, DropdownItem, DropdownMenu, DropdownSection, DropdownTrigger} from '@/components/ui';
...
export default function UserMenu() {
    ...
    const handleDebug = () => {
        const info = [
            ...
            `Tailscale: ${hasTailscale ? 'active' : 'inactive'}`,
            `CF Access: ${isCloudFlareAccess() ? 'yes' : 'no'}`,
        ].join('\n');
