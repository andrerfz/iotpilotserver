...
describe.skip('E2E: Device Lifecycle Journey', () => {
    // Skipping - requires refactoring to match new DeviceEntity structure and API
    ...
    describe('Step 1: Device Registration', () => {
        it('should register a new IoT device', async () => {
            ...
            deviceId = DeviceId.create(`device-lifecycle-${Date.now()}`);
