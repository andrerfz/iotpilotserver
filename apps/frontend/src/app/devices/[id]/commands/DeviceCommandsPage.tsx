                    ...
                    <Card>
                        ...
                        <CardBody>
                            {commandsLoading ? (
                                ...
                                <EmptyState
                                    icon={<Terminal className="w-12 h-12 text-default-300" />}
                                    title="No commands executed yet"
                                    description="Use the quick actions or custom command to get started"
                                />
                            ) : (
                                <div className="space-y-3">
                                            ...
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <StatusBadge status={command.status} variant="flat" size="sm" />
                                    ...
                                    <div className="space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <StatusBadge status={selectedCommandDetail.status} variant="flat" />
                                            </div>
                                            <div>
