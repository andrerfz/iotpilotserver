...
@Component({
  ...
  imports: [NgIf, NgFor, NgClass, NgTemplateOutlet, EmptyStateComponent],
  template: `
    <!-- Bulk-action bar -->
    <div *ngIf="selectable() && selected().length" class="selbar">
    ...
    <div class="tablewrap">
      <div style="overflow-x: auto;">
        <table class="table">
          <thead>
            <tr>
              <th *ngIf="selectable()" class="checkcell">
              ...
              <th *ngFor="let col of columns()"
                ...
                <span class="th-sort">
                  {{ col.label }}
                  <svg *ngIf="col.sortable && sort().key === col.key"
                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    width="12" height="12">
                    <polyline *ngIf="sort().dir === 1" points="18 15 12 9 6 15"></polyline>
                    <polyline *ngIf="sort().dir === -1" points="6 9 12 15 18 9"></polyline>
                  </svg>
                </span>
              </th>
            </tr>
          ...
          <tbody>
            ...
            <tr *ngFor="let row of pageView()"
              ...
              <td *ngFor="let col of columns()">
                ...
                <ng-template #defaultCell>{{ getValue(row, col.key) }}</ng-template>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="table__foot">
        <span>
          {{ sorted().length }} rows
          <ng-container *ngIf="selectable() && selected().length">
