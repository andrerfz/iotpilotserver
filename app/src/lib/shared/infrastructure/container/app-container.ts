...
import {createDeviceProvider} from '@/lib/device/infrastructure/providers/device.provider';
import {createUserProvider} from '@/lib/user/infrastructure/providers/user.provider';
import {createCustomerProvider} from '@/lib/customer/infrastructure/providers/customer.provider';
import {createMonitoringProvider} from '@/lib/monitoring/infrastructure/providers/monitoring.provider';
