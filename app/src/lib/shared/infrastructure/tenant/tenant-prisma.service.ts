                    ...
                    get: (model, method) => {
                        ...
                        return (...args: any[]) => {
                            ...
                            if (['findMany', 'findFirst', 'findUnique', 'count', 'aggregate'].includes(method as string)) {
                                ...
                                if (prop === 'customer' && newParams.where) {
                                    // If looking up by ID, ensure it matches the tenant ID
                                    if (newParams.where.id && newParams.where.id !== context.customerId) {
                                        ...
                                        newParams.where.id = context.customerId;
                                    }
                                    // If not looking up by ID, ensure any results are filtered to the tenant's customer
                                        ...
                                        newParams.where.AND.push({id: context.customerId});
                                    }
                                }
                                ...
                                if (prop === 'user') {
                                    this.addUserAccessFilter(newParams, context.customerId);
                            ...
                            // For update/delete operations
                                ...
                                if (prop === 'user') {
                                    ...
                                    if (newParams.where.id) {
                                        ...
                                        const tenantId = context.customerId;
