...
describe('WebSocketDeviceNotifier', () => {
  ...
  describe('sendCommandExecutionNotification', () => {
    it('should emit command execution notification to correct room', async () => {
  ...
  describe('sendDeviceOfflineNotification', () => {
    it('should emit device offline notification to correct room', async () => {
  ...
  describe('sendCustomNotification', () => {
    it('should emit custom notification to device room', async () => {
  ...
  describe('getConnectedClientsCount', () => {
    it('should return count of connected clients for device', () => {
      // Mock the userRooms to simulate connected clients
      const mockUserRooms = new Map();
      mockUserRooms.set('user-1', new Set(['socket-1', 'socket-2']));
      mockUserRooms.set('user-2', new Set(['socket-3']));
  ...
  describe('getSubscribedUsers', () => {
    it('should return list of users subscribed to device notifications', () => {
      const mockUserRooms = new Map();
      mockUserRooms.set('user-1', new Set(['socket-1']));
      mockUserRooms.set('user-2', new Set(['socket-2', 'socket-3']));
