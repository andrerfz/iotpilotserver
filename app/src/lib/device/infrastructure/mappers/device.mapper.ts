...
export class DeviceMapper {
  static toDomain(persistence: any, tenantContext?: TenantContext): DeviceEntity | null {
    ...
    const customerId = CustomerId.fromString(persistence.customerId);
    const name = DeviceName.fromString(persistence.deviceId || persistence.id); // Use deviceId as name if name doesn't exist
