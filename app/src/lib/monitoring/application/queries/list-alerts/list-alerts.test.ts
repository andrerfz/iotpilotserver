...
describe('ListAlertsHandler', () => {
  ...
  beforeEach(() => {
    ...
    customerId = CustomerId.create('customer-123');
    tenantContext = TenantContext.create(customerId);
  });
  ...
  describe('handle - tenant isolation', () => {
    ...
    it('should reject access to alerts from different tenant', async () => {
      // Arrange
      const wrongTenant = CustomerId.create('wrong-customer');
