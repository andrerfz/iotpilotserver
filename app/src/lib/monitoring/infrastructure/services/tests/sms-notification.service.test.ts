...
describe('SMSNotificationService', () => {
  ...
  describe('sendAlertNotification', () => {
    it('should return false when SMS notifications are disabled', async () => {
      ...
      const service = new SMSNotificationService();
      const result = await service.sendAlertNotification(alert, ['+1234567890'], CustomerId.create('tenant-1'));
    ...
    it('should return false when no phone numbers provided', async () => {
      ...
      const service = new SMSNotificationService();
      const result = await service.sendAlertNotification(alert, [], CustomerId.create('tenant-1'));
    ...
    it('should send SMS notifications successfully with Twilio', async () => {
      ...
      const service = new SMSNotificationService();
      const result = await service.sendAlertNotification(alert, ['+0987654321'], CustomerId.create('tenant-1'));
  ...
  describe('sendSummaryReport', () => {
    it('should send summary report successfully', async () => {
      ...
      const service = new SMSNotificationService();
      const result = await service.sendSummaryReport(reportData, ['+0987654321'], CustomerId.create('tenant-1'));
    ...
    it('should return false when SMS notifications are disabled', async () => {
      ...
      const service = new SMSNotificationService();
      const result = await service.sendSummaryReport({}, ['+1234567890'], CustomerId.create('tenant-1'));
  ...
  describe('createAlertMessage', () => {
    it('should create properly formatted alert message', () => {
      const service = new SMSNotificationService() as any;
