/**
 * Frontend types for alerts - aligned with DDD DTOs
 * These types are used in React components and hooks
 */

/**
 * Frontend Alert type (simplified from AlertDto for UI)
 */
...
/**
 * Alert statistics for frontend display
 */
...
/**
 * Alert configuration for frontend
 */
...
/**
 * Alert type definitions for UI dropdowns/filters
 */
...
/**
 * Alert severity type for frontend
 */
export type AlertSeverityType = 'INFO' | 'WARNING' | 'ERROR' | 'CRITICAL';

/**
 * Alert type string union for frontend
 */
