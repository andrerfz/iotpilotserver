...
/**
 * A generic hook for executing domain queries via API calls.
 * Queries are sent to the server which executes them through the QueryBus.
 * @template T The type of the query to execute.
 ...
 */
export function useQuery<T extends Query, R>(endpoint: string): {
