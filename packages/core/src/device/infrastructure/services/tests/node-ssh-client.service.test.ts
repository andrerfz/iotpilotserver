...
// Hoist mocks so they exist when vi.mock factory runs
const { mockNodeSSH, mockSSHConnection } = vi.hoisted(() => {
  ...
  return { mockNodeSSH, mockSSHConnection };
});
...
describe.skip('NodeSSHClientService', () => {
