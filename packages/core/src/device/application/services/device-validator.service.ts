...
import {DeviceNamingPolicy} from '@iotpilot/core/device/domain/policies/device-naming.policy';
import {InvalidDeviceDataException} from '@iotpilot/core/device/domain/exceptions/invalid-device-data.exception';
