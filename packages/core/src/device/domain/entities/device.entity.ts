...
export class DeviceEntity extends TenantScopedEntity<DeviceId> {
  ...
  // Extended display properties (hydrated from persistence, not part of core domain)
  ...
  public lastBoot?: Date;
  public uptimeStr?: string;
  ...
  toPersistence(): Record<string, unknown> {
    return {
      ...
      deviceId: this.getId().getValue(),
      customerId: this.getCustomerId()?.getValue(),
      hostname: this.hostname || null,
      deviceType: this.deviceType || 'GENERIC',
      deviceModel: this.deviceModel || null,
      architecture: this.architecture || this.osVersion || null,
      ...
      diskTotal: null,
      loadAverage: null,
      appStatus: this.appStatus || 'UNKNOWN',
      agentVersion: this.agentVersion || this.firmwareVersion || null,
      userId: null,
