...
describe('Metric Entity', () => {
  ...
  const mockCustomerId = CustomerId.create('c1234567890123456789012345');
  ...
  describe('tenant isolation', () => {
    it('should be tenant-scoped', () => {
      ...
      expect(metric.belongsToTenant(CustomerId.create('cothercustomer00000000000001'))).toBe(false);
    });
  });
});