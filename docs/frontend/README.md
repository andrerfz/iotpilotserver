...
|---|---|---|---|---|---|
| [fe-foundation](fe-foundation/) | Workspace, tooling, Docker, CI, Makefile, Husky | — | 4–6 | ✅ | pending |
| [fe-core](fe-core/) | Generated API client, auth, interceptors, guards, socket, CQRS buses | fe-foundation | 6–9 | ✅ | pending |
