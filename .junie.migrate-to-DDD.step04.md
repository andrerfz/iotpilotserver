...
## 👤 Task 4: Phase 4 - User Domain Migration (5-7 days)

### 🎯 Task 4.1: Create User Domain Value Objects
...
### 🧩 Task 4.2: Create User Domain Entities
...
### 🔐 Task 4.3: Create User Domain Services
...
### 📦 Task 4.4: Create User Domain Repositories
...
### 🔄 Task 4.5: Create User Application Commands
...
### 🔍 Task 4.6: Create User Application Queries
...
### 🔌 Task 4.7: Create User Infrastructure
...
### 🧪 Task 4.8: Create User Domain Tests
...
```typescript
// src/test/integration/xxx.test.ts
import {describe, it, expect, beforeEach} from 'vitest';
import {PrismaClient} from '@prisma/client';
